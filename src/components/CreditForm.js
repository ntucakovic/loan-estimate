...
class CreditForm extends Component {
  ...
  static DEFAULT_TRANSITION_STYLE = {
    transition: `opacity ${
      CreditForm.TRANSITION_DURATION
    }ms ease-in-out, max-height ${
      CreditForm.TRANSITION_DURATION
    }ms ease-in-out, transform ${CreditForm.TRANSITION_DURATION}ms ease-in-out`,
    opacity: 0,
    maxHeight: 0,
  ...
  render() {
    ...
    const showTotalAmountInput = !(
      calculation.squareMeterPrice && calculation.flatSize
    );
      ...
      <React.Fragment>
        <div className="credit-input" key="credit-input">
            ...
            {state => (
              ...
              >
                <div className="form-field-group">
                  <label
                    htmlFor="squareMeterPrice"
                    className="form-label form-label--with-prefix"
          ...
          >
            {state => (
              <div
                className={`form-field-group ${state}`}
                style={{
                  ...this.getTransitionStyles(state)
                }}
              >
